...
@Component({
  ...
  styles: ['#budgetChart{ background-color: #fafafa;} .budget-chart-canvas { width: 500px !important; height: 500px !important; position: relative; left: 20px; } .trial{ margin-left: 200px;  }'],
        ...
        options: {
          plugins: {
            legend: {
              labels: {
                font: {
                  size: 30, // Set the desired font size for labels
                },
              },
            },
          },
